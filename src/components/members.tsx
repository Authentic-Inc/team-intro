...
// @ts-ignore
// import MembersMDX from "../sections/members"
import MemberCard from "./member-card"
import josh from '../images/superman.png';
import weep from '../images/deadpool.png'
import arthur from '../images/sowrd.png'
    ...
    <Content speed={0.4} offset={offset + 0.2} factor={factor}>
      <Inner>
        ...
        <MemberCard
          ...
          >
            Backend Engineer / Carrots Enthusiast
        </MemberCard>
        <MemberCard
            title="Weep"
            img={weep}
